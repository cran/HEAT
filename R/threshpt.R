...
#### Plot0: plot of response variable on natural cubic spline of explanatory variable
...
#### Plot1: time-series plot of response variable and main exposure variable
#### Plot2: deviance~threshold point plot
#### Plot3: Estimated response value
#### Plot4: predicted response value with other mean covariates and 95% C.I.s
